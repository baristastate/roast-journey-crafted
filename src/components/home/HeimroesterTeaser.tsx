    ...
    <section className="theme-dark bg-ink-black text-pearl-white relative overflow-hidden">
      <div className="mx-auto max-w-[1400px] px-5 md:px-10 py-28 md:py-40 grid lg:grid-cols-2 gap-12 items-center">
        <div className="relative">
          {/* signature glow */}
          <div className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_top_left,rgba(255,79,139,0.22),transparent_60%)]" />
          ...
          <Reveal>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link to="/heimroester" className="rounded-full bg-magenta-coral text-pearl-white px-7 py-4 text-sm font-medium shadow-[0_20px_60px_-15px_rgba(255,79,139,0.6)]">Heimröster entdecken</Link>
